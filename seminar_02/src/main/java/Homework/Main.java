...
public class Main {
    ...
    public static void main(String[] args) {
        Homework.Render render = new Homework.Render();

        Homework.Building building = new Homework.Building(100);
        building.setCurrentHealthPoint(50);
        render.showIndicator(building, "Здание");
        System.out.println();

        Homework.Hero hero = new Homework.Hero(100, 50);
        hero.setCurrentHealthPoint(100);
        hero.setCurrentManaPoint(50);
        render.showIndicator(hero, "Герой");
        System.out.println();

        Homework.Neutral neutral = new Homework.Neutral(100);
